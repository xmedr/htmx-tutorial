...
from htmx_tut.logging import before_send
...
ROOT_URLCONF = 'htmx_tut.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['templates/', 'templates/htmx_tut'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'htmx_tut.context_processors.base_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'htmx_tut.wsgi.application'
